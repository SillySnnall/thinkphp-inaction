...
color: #333;font-size:24px} h1{ font-size: 100px; font-weight: normal; margin-bottom: 12px; } 
p{ line-height: 1.8em; font-size: 36px } a,a:hover{color:blue;}</style><div style="padding: 24px 48px;"> 
...
<thinkad id="ad_55e75dfae343f5a1"></thinkad><script type="text/javascript" 
